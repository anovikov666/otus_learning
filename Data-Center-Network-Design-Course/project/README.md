...
![Текущая топология](https://github.com/anovikov666/otus_learning/blob/main/Data-Center-Network-Design-Course/project/images/target_topology2.png)

Целевая схема будет включать в себя 4 коммутатора LEAF на каждой площадке, собранные с функционалом VPC для обеспечения отказоустойчивости подключения серверов. По 2 коммутатора уровня SPINE с широкими UPLINK портами и фаерволами для обеспечения возможности сегментирования доступа.

### Целевая схема топологии в лабе
...
На текущей схеме по одному BorderLeaf и всего один Router-Firewall,но этого будет достаточно чтобы реализовать цели проекта.
